...
export function LeftSidebar({ allShapes }: { allShapes: Array<any> }) {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section
        className="sticky left-0 flex h-full min-w-[227px] select-none flex-col overflow-y-auto
          border-t border-primary-grey-200 bg-primary-black pb-20 text-primary-grey-300
          max-sm:hidden"
      >
